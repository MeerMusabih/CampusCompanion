...
class _AddFoundItemScreenState extends State<AddFoundItemScreen> {
  ...
  final List<String> _keptLocations = [
    'Security Office', 'Department Office', 'With Me'
  ];
  ...
  Future<void> _submit() async {
    ...
    if (_selectedKeptLocation == null) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Please select where the item is kept")));
      return;
    }
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextField(
                    ...
                    hint: "e.g. Sports Ground, Room 102",
                    validator: (v) => v!.isEmpty ? "Required" : null,
                  ),
                  const SizedBox(height: 16),
                  Row(
                  ...
                  const SizedBox(height: 16),
                  _buildDropdownField(
                    label: "Where Item Is Kept",
                    value: _selectedKeptLocation,
                    items: _keptLocations,
                    hint: "Select Handover Location",
                    onChanged: (val) => setState(() => _selectedKeptLocation = val),
                  ),
